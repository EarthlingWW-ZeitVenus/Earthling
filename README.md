...
Сейчас, паралельно программированию, изучаю влияние гормонов и нейеромедиаторов на организм. Разрабатываю свою систему тренировок, сна и питания, для выработки сопутствующих (для достижения цели) состояний.
...
## Идеология
Предпочитаю поднимать смежные дисциплины и не специализироваться только в одной области.

Пишу глобальные идейные проекты. Они во многом пересекаются с идеями, изложенными в таких фильмах как "Zeitgeist", "Thrive", "Crossroads", "What the bleep do we know!?: down the rabbit hole".

*Веб-программирования для меня - удобный инструмент для реализации моих идей*
