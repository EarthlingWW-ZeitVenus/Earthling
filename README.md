...
+ визуализация процессов, лучше воспринимается чем текст или звук, поэтому сделал упор на анимацию и 3D-графику

## О причинах смены основного направления (с системного администратора на веб-программиста):
+ JS можно использовать для написания скриптов к ОС, автоматизировать рутину. Меньше рутины, больше времени для творчества и новых идей. Обе профессии будут дополнять друг друга.
+ Системное администрирование не давало большого количества возможностей для самовыражения и реализации своих идей.
